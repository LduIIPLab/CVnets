...
@register_dataset(name="food_another", task="classification")
class ImagenetDataset(BaseImageDataset, ImageFolder):
    ...
    def __init__(
        ...
        **kwargs
        ...
        setattr(opts, "dataset.collate_fn_name_train", "food_another_collate_fn")
        setattr(opts, "dataset.collate_fn_name_val", "food_another_collate_fn")
        setattr(opts, "dataset.collate_fn_name_eval", "food_another_collate_fn")
    ...
    def add_arguments(cls, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        group.add_argument(
            "--dataset.food_another.crop-ratio",
            type=float,
            default=0.875,
            help="Crop ratio",
        )
...
@register_collate_fn(name="food_another_collate_fn")
